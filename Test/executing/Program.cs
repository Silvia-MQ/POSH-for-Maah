...
namespace Test
{
    class Program
    {
        ...
        protected POSH.sys.Tuple<bool, bool, string> ProcessOptions(string[] args)
        {
            // default values
            ...
            if (help)
                return new POSH.sys.Tuple<bool, bool, string>(help, false, "");

            // all fine
            return new POSH.sys.Tuple<bool, bool, string>(help, verbose, plan);
        }
        ...
        public static void Main(string[] args)
        {
            ...
            POSH.sys.Tuple<bool, bool, string> arguments = null;
            ...
            PLANTYPE type = AgentFactory.getPlanType(plan);
            Console.Out.WriteLine("plan type +{0}", type);
            Console.ReadKey();

            agents = AgentFactory.CreateAgents("", plan, null, null); // agentsInit, setting.First);
